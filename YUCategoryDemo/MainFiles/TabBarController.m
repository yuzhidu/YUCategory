...
//    [[UITabBar appearance] setBarTintColor:[UIColor redColor]];
    ...
    [[UITabBar appearance] setBackgroundImage:[UIImage yu_createImageWithColor:kColorWithRGB(233, 233, 233)]];
    
    // 普通状态下的文字属性
    NSMutableDictionary *normalAttrs = [NSMutableDictionary dictionary];
    normalAttrs[NSForegroundColorAttributeName] = kColorWithRGB(102, 102, 102);
    // 选中状态下的文字属性
    NSMutableDictionary *selectedAttrs = [NSMutableDictionary dictionary];
    selectedAttrs[NSForegroundColorAttributeName] = kColorTheme;
